        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InvoiceRemarks = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PurchaseOrderNumber = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.InsertData(
                table: "ShopConfigs",
                columns: new[] { "Id", "Address", "Email", "GSTNumber", "InvoiceRemarks", "MobileNumber", "ShopName" },
                values: new object[] { 1, "", "", "", "", "", "" });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "CreatedAt", "Email", "IsActive", "PasswordHash", "Role", "Username" },
                values: new object[] { 1, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "admin@mobilebilling.com", true, "$2a$11$SmchrSo9nonfeQQlZGYVC.8A2bBQjOg769x734tgWn8vnNONlA3X.", "Admin", "admin" });
